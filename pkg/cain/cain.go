...
func SchemaBackup(o SchemaBackupOptions) (string, error) {
	...
	log.Println("Calculating paths. This may take a while...")
	fromToPathsCassandraKeySpace, err := utils.GetFromToPathsCassandraKeySpace(k8sClient, pods, o.Namespace, o.Container, o.Keyspace, tag, dstBasePath, o.CassandraDataDir)
	if err != nil {
		return "", err
	}
...
type RestoreSchemaOptions struct {
	Src              string
	Keyspace         string
	Tag              string
	Schema           string
...
// RestoreSchema performs backup
func RestoreSchema(o RestoreSchemaOptions) error {
	log.Println("Restore started!")
	log.Println("Restore Schema Options: \n", o)
	srcPrefix, srcBasePath := utils.SplitInTwo(o.Src, "://")
	log.Println("srcPrefix: ", srcPrefix, "srcBasePath: ", srcBasePath)
	...
	log.Println("existingPods: ", existingPods)
	...
	log.Println("srcPath", srcPath, "fromToPaths: ", fromToPaths, "podsToBeRestored: ", podsToBeRestored, "tablesToRefresh", tablesToRefresh)
